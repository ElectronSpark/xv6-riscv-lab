...
/** Set the IST2 stack pointer in this CPU's TSS. */
void x86_tss_set_ist2(uint64 ist2);

/** Set the IST1 stack pointer in the TSS for a specific CPU. */
void x86_tss_set_ist1_cpu(int cpu, uint64 ist1);

/** Set the IST2 stack pointer in the TSS for a specific CPU. */
