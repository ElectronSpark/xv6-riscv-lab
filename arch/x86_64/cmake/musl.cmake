...
set(MUSL_DYNAMIC_LINKER_PATH "/lib/ld-musl-x86_64.so.1")
...
#
# Even when the xv6 musl toolchain exists, rebuilding musl into the workspace
# sysroot keeps the runtime loader and headers in sync with local ABI fixes
# (for example mmap syscall numbering and arch-specific stat layout).
# ==============================================================================
set(MUSL_ARCH_DEPS
