# default.cmd - U-Boot script for default Orange Pi Linux boot
#
# Modified from boot.cmd in the Orange Pi official U-Boot repository:
# https://github.com/orangepi-xunlong/OrangePi_Build
#
# This script is sourced from boot.cmd when default boot is selected.
# It loads the standard Orange Pi Linux kernel, initrd, and device tree,
# then boots using the standard boot sequence.
#
# This file is provided as a reference and for dual-boot configurations.
# It mirrors the original Orange Pi boot process.
#
...
# Recompile with:
# mkimage -C none -A riscv -T script -d /boot/default.cmd /boot/default.scr
