...
#define CLONE_CHILD_CLEARTID                                                   \
    0x00010000 // Clear child TID in child's memory on exit
#define CLONE_CHILD_SETTID                                                     \
    0x00020000 // Set child TID in child's memory on creation
...
#define CLONE_PARENT_SETTID                                                    \
    0x0010000000 // Set parent TID in parent's memory on child creation
