...
#define MAKE_PRIORITY(major, minor)                                            \
    (((major) << PRIORITY_MAINLEVEL_SHIFT) | (minor))
#define IDLE_PRIORITY MAKE_PRIORITY(IDLE_MAJOR_PRIORITY, DEFAULT_MINOR_PRIORITY)
#define DEFAULT_PRIORITY                                                       \
    MAKE_PRIORITY(DEFAULT_MAJOR_PRIORITY, DEFAULT_MINOR_PRIORITY)
...
// Note: time_slice is currently a placeholder and not enforced by the
// scheduler.
