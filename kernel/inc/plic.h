...
#define PLIC_CONTEXT_ENABLE(context) ((uint32 *)(PLIC + 0x2000 + ((context) << 7)))
#define PLIC_MENABLE(hart) ((uint32 *)(PLIC_ENABLE_BASE + ((hart) << 8)))
#define PLIC_SENABLE(hart) ((uint32 *)((void *)PLIC_MENABLE(hart) + 0x80))
#define PLIC_CONTEXT_PRIORITY_THRESH(hart) ((uint32 *)(PLIC_PRIORITY_THRESH_BASE + ((hart) << 12)))
#define PLIC_MPRIORITY_THRESH(hart) ((uint32 *)(PLIC_PRIORITY_THRESH_BASE + ((hart) << 13)))
#define PLIC_SPRIORITY_THRESH(hart) ((uint32 *)((void *)PLIC_MPRIORITY_THRESH(hart) + 0x1000))
