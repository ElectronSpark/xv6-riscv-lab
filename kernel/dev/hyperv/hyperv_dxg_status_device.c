                             ...
                             size_t *read_status_len)
{
    ...
    len = snprintf(status, status_size,
        ...
        "dxg_host_to_vm_last=packets:%u unknown:%u cmd:%u channel:%u payload:%u cmdid:%lu presenthistory:%u presenthistory_len:%u presenthistory_cmdid:%lu presenthistory_head_len:%u head:%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x\n"
        ...
        "dxg_display_bind_pin_diag=ret:%d reason:%u dxg_fd:%d resource_fd:%d req:dev0x%x/res0x%x/alloc0x%x/count%u shared:kind%u/fops%u/global0x%x parent:present%u/dev0x%x/res0x%x/alloc0x%x/count%u/global0x%x/sealed%u/records%u/gen%u dxg_file_ok:%u owner:0x%x/%u/%u opened:present%u/dev0x%x/res0x%x/alloc0x%x/count%u/global0x%x selected:%u\n"
        ...
        "dxg_context_unwind=attempts:%u successes:%u ret:%d process:0x%x context:0x%x\n"
        ...
        hvdxg.host_to_vm_last_command,
        hvdxg.host_to_vm_last_channel,
        hvdxg.host_to_vm_last_payload_len,
        hvdxg.host_to_vm_last_command_id,
        hvdxg.host_to_vm_presenthistory_packets,
        hvdxg.host_to_vm_presenthistory_last_len,
        hvdxg.host_to_vm_presenthistory_last_command_id,
        hvdxg.host_to_vm_presenthistory_head_len,
        hvdxg.host_to_vm_presenthistory_head[0],
        hvdxg.host_to_vm_presenthistory_head[1],
        hvdxg.host_to_vm_presenthistory_head[2],
        hvdxg.host_to_vm_presenthistory_head[3],
        hvdxg.host_to_vm_presenthistory_head[4],
        hvdxg.host_to_vm_presenthistory_head[5],
        hvdxg.host_to_vm_presenthistory_head[6],
        hvdxg.host_to_vm_presenthistory_head[7],
        hvdxg.host_to_vm_presenthistory_head[8],
        hvdxg.host_to_vm_presenthistory_head[9],
        hvdxg.host_to_vm_presenthistory_head[10],
        hvdxg.host_to_vm_presenthistory_head[11],
        hvdxg.host_to_vm_presenthistory_head[12],
        hvdxg.host_to_vm_presenthistory_head[13],
        hvdxg.host_to_vm_presenthistory_head[14],
        hvdxg.host_to_vm_presenthistory_head[15],
        ...
        hvdxg.display_bind_pin_last_ret,
        hvdxg.display_bind_pin_last_reason,
        hvdxg.display_bind_pin_last_dxg_fd,
        hvdxg.display_bind_pin_last_resource_fd,
        hvdxg.display_bind_pin_last_device,
        hvdxg.display_bind_pin_last_resource,
        hvdxg.display_bind_pin_last_allocation,
        hvdxg.display_bind_pin_last_allocation_count,
        hvdxg.display_bind_pin_last_shared_kind,
        hvdxg.display_bind_pin_last_fops_kind,
        hvdxg.display_bind_pin_last_shared_global,
        ...
        hvdxg.display_bind_pin_last_dxg_file_ok,
        ...
        hvdxg.display_bind_pin_last_opened_present,
        ...
        hvdxg.display_bind_pin_last_selected,
        ...
        hvdxg.createcontext_unwind_ret,
        hvdxg.createcontext_unwind_process,
        hvdxg.createcontext_unwind_context,
        ...
        hvdxg.createhwqueue_unwind_ret,
        hvdxg.createhwqueue_unwind_process,
        hvdxg.createhwqueue_unwind_queue,
        hvdxg.createhwqueue_unwind_fence,
    ...
    if ((size_t)len < status_size) {
        len += snprintf(status + len, status_size - (size_t)len,
            ...
            "dxg_createdevice_unwind=attempts:%u successes:%u ret:%d "
            "process:0x%x device:0x%x\n"
            ...
            hvdxg.createdevice_unwind_ret,
            hvdxg.createdevice_unwind_process,
            hvdxg.createdevice_unwind_device,
