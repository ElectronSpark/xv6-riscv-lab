...
#define PROCFS_STATIC_FILE(ino_value, type_value, size_value) do {    \
    ...
    PROCFS_STATIC_DIR(PROCFS_INO_SYS_FS_INOTIFY, PROC_SYS_FS_INOTIFY_DIR);
    ...
    PROCFS_STATIC_FILE(PROCFS_INO_SYS_FS_INOTIFY_MAX_USER_WATCHES, PROC_SYS_FS_INOTIFY_MAX_USER_WATCHES, 32);
    PROCFS_STATIC_FILE(PROCFS_INO_SYS_FS_INOTIFY_MAX_USER_INSTANCES, PROC_SYS_FS_INOTIFY_MAX_USER_INSTANCES, 32);
    PROCFS_STATIC_FILE(PROCFS_INO_SYS_FS_INOTIFY_MAX_QUEUED_EVENTS, PROC_SYS_FS_INOTIFY_MAX_QUEUED_EVENTS, 32);
