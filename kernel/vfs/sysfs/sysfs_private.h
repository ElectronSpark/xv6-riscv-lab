...
#define SYSFS_INO_CLASS_SOUND          31ULL
#define SYSFS_INO_CLASS_SOUND_CARD0    32ULL
#define SYSFS_INO_CLASS_SOUND_CONTROL0 33ULL
#define SYSFS_INO_CLASS_SOUND_PCM0P    34ULL
...
#define SYSFS_INO_CLASS_SOUND_CARD_ATTR_BASE 300ULL
#define SYSFS_INO_CLASS_SOUND_CONTROL_ATTR_BASE 332ULL
#define SYSFS_INO_CLASS_SOUND_PCM_ATTR_BASE 364ULL
...
enum sysfs_device_kind {
    ...
    SYSFS_DEV_SOUND_CARD,
    SYSFS_DEV_SOUND_CONTROL,
    SYSFS_DEV_SOUND_PCM,
};
